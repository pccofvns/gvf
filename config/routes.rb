Rails.application.routes.draw do
 ...
 # The priority is based upon order of creation: first created -> highest priority.
  ...
  get 'b3p',   :to => 'pages#b3p'
  get 'edu',   :to => 'pages#edu'
  get 'energy',   :to => 'pages#energy'
  get 'env',   :to => 'pages#env'
  get 'industry',   :to => 'pages#industry'
  get 'it',   :to => 'pages#it'
  get 'operations',   :to => 'pages#operations'
  get 'finance',   :to => 'pages#finance'
  get 'pubhealth',   :to => 'pages#pubhealth'
  get 'skill',   :to => 'pages#skill'
  get 'tourism',   :to => 'pages#tourism'
  get 'urbdev',   :to => 'pages#urbdev'
  ...
  get 'directors',   :to => 'pages#directors'
